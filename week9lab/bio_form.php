...
<input type="radio" name="sex" id="idsex" value="male" style="width: 60px">Male<br>
<input type="radio" name="sex" id="idsex" value="female" style="width: 60px">Female<br>
...
<input type="submit" name="biodata_form" value="Submit My Biodata" class="button">
