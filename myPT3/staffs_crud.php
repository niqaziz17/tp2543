...
if (isset($_POST['create'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO tbl_staff_a174622_pt2(FLD_STAFF_ID, FLD_STAFF_NAME, FLD_STAFF_PHONENUM) VALUES(:sid, :name, :phonenum)");
