   ...
   <div class="row">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
     <div class="form-group">
          ...
          <div class="col-sm-9">
         <input name="cid" type="text" class="form-control" id="customerid" value="<?php if(isset($_GET['edit'])) echo $editrow['FLD_CUSTOMER_ID']; else echo sprintf('C%02d',$cid); ?>" readonly> <br />
      </div>
        </div>
